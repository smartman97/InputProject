...
{
	//Declaration section for instance variable.
	...
	private void questions()
	{
		...
		System.out.println("Hello there " + myInput + ", do you like programming?");
		...
		System.out.println("You are " + age + " years old? Awesome Sauce!");
	}
}
